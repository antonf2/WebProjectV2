                    ...
                    <Modal.Body>
                        <Form>
                            ...
                            >
                                ...
                                <Form.Control name="description" as="textarea" type="text" onChange={handleChange} value={cardData.description} rows={2} placeholder="Describe your business" />
                            </Form.Group>
                        </Form>
                    </Modal.Body>
                    <Modal.Footer>
